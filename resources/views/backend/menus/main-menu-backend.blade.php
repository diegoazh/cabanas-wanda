<ul class="menu">
  ...
  em"><a href="{{ route('cottages.index') }}">Listado de caba&ntilde;as<span>{{ (isset($cantCottages)) ? $cantCottages : 0 }}</span></a></li>
    ...
    <li class="item" style="display: none"><a href="#" class="promotion">Promociones <span>{{ isset($cantPromotions) ? $cantPromotions : 0 }}</span></a>
        <ul>
            <li class="subitem"><a href="{{ route('promotions.index') }}">Promociones <span>{{ isset($cantPromotions) ? $cantPromotions : 0 }}</span></a></li>
        </ul>
    </li>
    <li class="item" style="display: none"><a href="#" class="claims">Reclamos <span>{{ isset($cantClaims) ? $cantClaims : 0 }}</span></a>
        <ul>
