...
@section('content3')
    <p class="text-justify text-muted"><small>Este email no te ha suscripto a ninguna lista de emails ni lo hará. Tu información únicamente será usada en nuestro sitio y no se la proporcionaremos a nadie sin tu expreso consentimiento. Cuando te enviemos un email siempre sera desde alguna de estas casilla: administracion@cabaniasdewanda.com.ar o cabaniasdewanda@gmail.com y solo lo haremos para informarte de alguna promoción o sobre algún cambio que se haya realizado o este programado a futuro. No avalamos el spam en ninguna de sus formas por lo cual nunca recibirás correo basura de nuestra parte. Si en algún momento llegara a suceder por favor informanos de la situación a la brevedad. Este mail fué generado automaticamente por la aplicación web de nuestro sitio pero si tienes alguna duda o necesitas información puedes responderlo y te responderemos a la brevedad vía mail.</small></p>
@endsection
